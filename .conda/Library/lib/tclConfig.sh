...
# installed.
TCL_PREFIX='c:/Users/Admin/Desktop/Dissertação/código/codigo_reproducao_resultados/evaluation-pipeline-2024/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='c:/Users/Admin/Desktop/Dissertação/código/codigo_reproducao_resultados/evaluation-pipeline-2024/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='c:/Users/Admin/Desktop/Dissertação/código/codigo_reproducao_resultados/evaluation-pipeline-2024/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ic:/Users/Admin/Desktop/Dissertação/código/codigo_reproducao_resultados/evaluation-pipeline-2024/.conda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lc:/Users/Admin/Desktop/Dissertação/código/codigo_reproducao_resultados/evaluation-pipeline-2024/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='c:/Users/Admin/Desktop/Dissertação/código/codigo_reproducao_resultados/evaluation-pipeline-2024/.conda\Library\lib\tclstub86.lib'
